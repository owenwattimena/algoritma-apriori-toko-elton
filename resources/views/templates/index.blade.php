    ...
    <div class="main-wrapper">
        ...
        <nav class="settings-sidebar">
            <div class="sidebar-body">
                ...
                <h6 class="text-muted mb-2">Theme:</h6>
                ...
                {{-- <div class="theme-wrapper">
                    ...
                    <a class="theme-item active" href="{{ url('/') }}/demo1/dashboard.html">
                        <img src="{{ url('/') }}/assets/images/screenshots/light.jpg" alt="light theme">
                    </a>
                    <h6 class="text-muted mb-2">Dark Theme:</h6>
                    <a class="theme-item" href="{{ url('/') }}/demo2/dashboard.html">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="languageDropdown">
                                <a href="javascript:;" class="dropdown-item py-2"><i class="flag-icon flag-icon-id" title="id" id="id"></i> <span class="ms-1"> Indonesia </span></a>
