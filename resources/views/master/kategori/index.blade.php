                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('master.kategori.create') }}" class="forms-sample" method="POST">
                            ...
                            <div class="modal fade" id="exampleModal-{{ $item->slug }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('master.kategori.update', $item->slug) }}" class="forms-sample" method="POST">
                                            <div class="modal-body">
                                                @csrf
                                                @method('put')
                                                <div class="mb-3">
