                            ...
                            <li class="list-group-item pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="inputNoFaktur" placeholder="No. Faktur/Invoice/Nota" name="nomor_faktur">
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="inputPenyedia" class="form-label">Penyedia</label>
                                        <input type="text" class="form-control form-control-sm" id="inputPenyedia" placeholder="Penyedia" name="penyedia">
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <label for="inputTanggal" class="form-label">Tanggal</label>
                                        <input type="date" class="form-control form-control-sm" id="inputTanggal" name="tanggal">
                                    </div>
                                    <div class="col-md-2 mb-3">
                                        <label for="inputJam" class="form-label">Jam</label>
                                        <input type="time" class="form-control form-control-sm" id="inputJam" name="jam">
                                    </div>
                                </div>
                            </li>
                        </ul>
                                    ...
                                    <table id="dataTableExample" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $item->final_at }}</td>
                                                <td>
                                                    <a href="{{ route('transaksi.pembelian.show', $item->id) }}" class="btn btn-xs btn-secondary rounded-0 border-dark">Lihat</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
