...
@section('title', 'Transaksi > Pembelian > Detail')
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Detail Transaksi Pembelian</h6>
                            ...
                            <li class="list-group-item pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="inputNoFaktur" class="form-label">No. Faktur/Invoice/Nota</label>
                                        <input type="text" class="form-control form-control-sm" id="inputNoFaktur" placeholder="No. Faktur/Invoice/Nota" name="nomor_faktur" value="{{ $transaksi->nomor_faktur }}" disabled readonly>
                                    </div>
                                    <div class="col-md-3 mb-3">
                                        <label for="inputPenyedia" class="form-label">Penyedia</label>
                                        <input type="text" class="form-control form-control-sm" id="inputPenyedia" placeholder="Penyedia" name="penyedia" value="{{ $transaksi->penyedia }}" disabled readonly>
                                    </div>
                                    <div class="col-md-2 mb-3">
                            ...
                            <li class="list-group-item pb-0">
                                <table class="w-100 table table-sm" >
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td> Rp. <input id="sub_total" value="{{ $diskon + $total }}" type="text" disabled readonly></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Diskon
                                        ...
                                        <td>:</td>
                                        <td> Rp. <input id="total_diskon" value="{{ $diskon }}" type="text" disabled readonly></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Total
                                        ...
                                        <td>:</td>
                                        <td> Rp. <input id="grand_total" type="text" value="{{ $total }}" disabled readonly ></td>
                                    </tr>
                                </table>
                            </li>
                        </ul>
